...
export class MatrixStack {
  private static instance: MatrixStack;
  ...
  /**
   * Devuelve la instancia del stack de matrices.
   * @return {MatrixStack} Instancia
   */
  public static getInstance(): MatrixStack {
    if (!MatrixStack.instance) {
